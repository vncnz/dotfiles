...
/*
        Repeater {
            ...
            Rectangle {
                ...
                /* Windows list for each workspace * /
                ...
                Column {
                    ...
                    Text {
                        ...
                        font.pixelSize: model.isFocused ? 14 : 10
                    ...
                    Repeater {
                        ...
                        delegate: Rectangle {
                            visible: model.workspaceId === workspace_id && w.output == currentScreen.name
                            width: 16
                            height: 16
                            color: "transparent"
                            ...
                            Rectangle {
                                ...
                                visible: workspaceColumn.getAppIcon(model) == ''
                                Text {
                                    color: "black"
                                    anchors.centerIn: parent
